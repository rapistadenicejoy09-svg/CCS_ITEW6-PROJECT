...
export const PERMISSIONS = {
  ...
  FACULTY_DIRECTORY_VIEW: 'faculty:directory_view',
  ...
  FACULTY_SCHEDULE_VIEW: 'faculty_schedule:view',
  STUDENT_SCHEDULE_VIEW: 'student_schedule:view',
...
const ROLE_PERMISSIONS = {
  [ROLES.ADMIN]: [
    ...
    PERMISSIONS.FACULTY_DIRECTORY_VIEW,
    ...
    PERMISSIONS.FACULTY_SCHEDULE_VIEW,
...
export const PATH_PERMISSIONS = {
  ...
  '/scheduling/add': PERMISSIONS.SCHEDULING_MANAGE,
  '/student/schedule': PERMISSIONS.STUDENT_SCHEDULE_VIEW,
  '/faculty/schedule': PERMISSIONS.FACULTY_SCHEDULE_VIEW,
  ...
  '/admin/faculty': PERMISSIONS.ADMIN_PROFILE,
